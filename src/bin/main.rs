use asteroid::{
    component::{
        Acceleration, CollisionMask, DelayedAdd, ExitBehaviour, Friction, LayerMask,
        PlayerControlled, Thrust, Velocity, OBSTACLE, PLAYER,
    },
    AsteroidPlugin,
};
...
fn setup_environment(commands: &mut Commands, mut materials: ResMut<Assets<ColorMaterial>>) {
    for ix in 0..16 {
        for iy in 0..16 {
...
fn main() {
    App::build()
        ...
        .add_startup_system(setup_asteroids.system())
